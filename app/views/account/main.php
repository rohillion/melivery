...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Admin - <?php echo (Request::segment(1))? Lang::get('segment.category.name') : 'Dashboard' ;?> control panel</title>
        ...
        <!-- Ionicons -->
        <link href="assets/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Morris chart -->
        <link href="assets/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- jvectormap -->
        <link href="assets/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- Date Picker 
        ...
        <link href="assets/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
    ...
    <body class="skin-black">
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="attribute">
                                <i class="fa fa-th"></i> <span>ABM Atributos</span>
                            </a>
                        </li>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <?php Request::segment(1)? include(Request::segment(1).'.php') : 'dashboard.php'; ?>
        ...
        <!-- jQuery UI 1.10.3 -->
        <script src="assets/jquery-ui-1.10.3.min.js" type="text/javascript"></script>
        <!-- Bootstrap -->
        ...
        <!-- jQuery Knob Chart -->
        <script src="assets/plugins/jqueryKnob/jquery.knob.js" type="text/javascript"></script>
        <!-- daterangepicker -->
        ...
        <!-- AdminLTE App -->
        <script src="assets/AdminLTE/app.js" type="text/javascript"></script>

        <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
        <script src="assets/AdminLTE/dashboard.js" type="text/javascript"></script>

        <!-- AdminLTE for demo purposes 
        <script src="assets/AdminLTE/demo.js" type="text/javascript"></script>-->
