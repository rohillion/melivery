    ...
    <body class="background error-page-wrapper background-color background-image">
        ...
        <div class="content-container shadow">
            ...
            <div class="subheader primary-text-color">
                Oops! Aparentemente se presento un problema.
            </div>
            <div class="hr"></div>
            <div class="context secondary-text-color">

                <p>
                    Por favor, vuelve a la pagina anterior e int&eacute;ntalo de nuevo.
                    Si supones que algo anda mal, por favor rep&oacute;rtalo.
                </p>


            </div>
            <div class="buttons-container single-button">
                <a class="button" href="mailto:soporte@melivery.com.ar" target="_blank"><span class="fa fa-warning"></span> Reportar</a>
            </div>
        </div>
