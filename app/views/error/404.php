...
<html>
  ...
  @media screen and (max-width: 450px) {
    ...
    .background-image {
      ...
      background-image: url(http://wallfon.com/walls/others/delicious-food.jpg) !important;
    }
    ...
    .border-button {
      color: rgba(204, 34, 34, 1) !important;
      border-color: rgba(204, 34, 34, 1) !important;
    }
    .button {
      background-color: rgba(204, 34, 34, 1) !important;
  ...
  <div class="content-container shadow">
    ...
    <div class="subheader primary-text-color">
        Oops, la p&aacute;gina que buscas no existe.
    </div>
    <div class="hr"></div>
    <div class="context secondary-text-color">
      <p>
        Puedes volver al inicio haciendo click en el boton de abajo.
        Si supones que hay algo que anda mal, por favor rep&oacute;rtalo.
      </p>
    </div>
    <div class="buttons-container">
      <a class="button" href="/"><span class="fa fa-home"></span> Volver al inicio</a>
      <a class="button" href="mailto:soporte@melivery.com.ar" target="_blank"><span class="fa fa-warning"></span> Reportar problema</a>
    </div>
  </div>
</center>
